...
class VPropertyController extends Controller
{
    
    public function index()
    {
        return view('vendor.property.form');
    }
   ...
   public function propertyList(Request $request)
    {
       if ($request->ajax()) {
            $data = DB::table('properties')->where('created_by',Auth::user()->id)->orderby('id','desc')->get();
            return Datatables::of($data)
                   ...
                   ->addColumn('property_name', function($data){
                    ...
                    ->addColumn('action', function($data){
                           ...
                           $btn='<a href="'.route('vendor_property_view',$data->id).'" class="btn btn-info btn-sm action"   title="View"><i class="ri-eye-fill"></i></a>
                           |
        ...
        return view('vendor/property/property_list');
    ...
    public function propertyView($id)
    {
        ...
        return view('vendor/property/property_view',$data);
    }
