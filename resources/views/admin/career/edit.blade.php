...
<form action="{{ url('admin/updateCareer',['career'=>$career->id]) }}" method="post" enctype="multipart/form-data">
 @csrf 
<div class="row"  >
      ...
      <div class="card" >
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h6 class="card-title"> Edit Career Details </h6>
             </div>
          </div>
          <div class="card-body">
               <div class="row">
                     ...
                     <div class="col-sm-3" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="text" class="form-control" name="postName" value="{{$career->postName}}">
                         </div>
                      </div>
                      ...
                      <div class="col-sm-4" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="text" class="form-control" name="postType"value="{{$career->postType}}"> 
                         </div>
                      </div>
</div>
<div class="row">
                      <div class="col-sm-4" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="text" class="form-control" name="jobDesc" value="{{$career->jobDesc}}"> 
                         </div>
                      </div>
              </div>
          </div>
