 ...
 <div class="row">
    <div class="col-sm-12 col-lg-12">
       <div class="card">
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h4 class="card-title">Location Advantage </h4>
             </div>
          </div>
          <div class="card-body">
...
<?php
$garden = encrypt('<div class="form-group col-sm-3">
                           <label>Garden</label>
                            <select name="garden" class="form-control form-control-sm mb-3">
...
?> 
                        <div class="form-group col-sm-3">
                           <label>Garden <input name="location_advantage[garden]" type="checkbox" style="margin-left:10px;" value="<?=$garden?>" > </label>
                            <select name="garden" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>  
...
<?php
$wi_fi_internet = encrypt('<div class="form-group col-sm-3">
                           <label>Wi-Fi Internet</label>
                            <select name="wi_fi_internet" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label>Wi-Fi Internet <input name="location_advantage[wi_fi_internet]" type="checkbox" style="margin-left:10px;" value="<?=$wi_fi_internet?>" > </label>
                            <select name="wi_fi_internet" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$pool = encrypt('<div class="form-group col-sm-3">
                           <label> Pool </label>
                            <select name="pool" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Pool <input name="location_advantage[pool]" type="checkbox" style="margin-left:10px;" value="<?=$pool?>" > </label>
                            <select name="pool" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$fitness_center = encrypt('<div class="form-group col-sm-3">
                           <label> Fitness Center </label>
                            <select name="fitness_center" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Fitness Center <input name="location_advantage[fitness_center]" type="checkbox" style="margin-left:10px;" value="<?=$fitness_center?>" > </label>
                            <select name="fitness_center" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$gym = encrypt('<div class="form-group col-sm-3">
                           <label> Gym </label>
                            <select name="gym" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Gym <input name="location_advantage[gym]" type="checkbox" style="margin-left:10px;" value="<?=$gym?>" > </label>
                            <select name="gym" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$near_beach = encrypt('<div class="form-group col-sm-3">
                           <label> Near Beach </label>
                            <select name="near_beach" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Near Beach <input name="location_advantage[near_beach]" type="checkbox" style="margin-left:10px;" value="<?=$near_beach?>" > </label>
                            <select name="near_beach" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$parking = encrypt('<div class="form-group col-sm-3">
                           <label> Parking </label>
                            <select name="parking" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Parking <input name="location_advantage[parking]" type="checkbox" style="margin-left:10px;" value="<?=$parking?>" > </label>
                            <select name="parking" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$security = encrypt('<div class="form-group col-sm-3">
                           <label> Security </label>
                            <select name="security" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Security <input name="location_advantage[security]" type="checkbox" style="margin-left:10px;" value="<?=$security?>" > </label>
                            <select name="security" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$see_view = encrypt('<div class="form-group col-sm-3">
                           <label> See View </label>
                            <select name="see_view" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> See View <input name="location_advantage[see_view]" type="checkbox" style="margin-left:10px;" value="<?=$see_view?>" > </label>
                            <select name="see_view" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$break_fast = encrypt('<div class="form-group col-sm-3">
                           <label> BreakFast </label>
                            <select name="break_fast" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> BreakFast <input name="location_advantage[break_fast]" type="checkbox" style="margin-left:10px;" value="<?=$break_fast?>" > </label>
                            <select name="break_fast" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$lunch_include = encrypt('<div class="form-group col-sm-3">
                           <label> Lunch Included </label>
                            <select name="lunch_include" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Lunch Included <input name="location_advantage[lunch_include]" type="checkbox" style="margin-left:10px;" value="<?=$lunch_include?>" > </label>
                            <select name="lunch_include" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$dinner_include = encrypt('<div class="form-group col-sm-3">
                           <label> Dinner Included </label>
                            <select name="dinner_include" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Dinner Included <input name="location_advantage[dinner_include]" type="checkbox" style="margin-left:10px;" value="<?=$dinner_include?>" > </label>
                            <select name="dinner_include" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$express_check_in = encrypt('<div class="form-group col-sm-3">
                           <label> Express Check-In </label>
                            <select name="express_check_in" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Express Check-In <input name="location_advantage[express_check_in]" type="checkbox" style="margin-left:10px;" value="<?=$express_check_in?>" > </label>
                            <select name="express_check_in" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$late_check_out = encrypt('<div class="form-group col-sm-3">
                           <label> Late Check-out </label>
                            <select name="late_check_out" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Late Check-out <input name="location_advantage[late_check_out]" type="checkbox" style="margin-left:10px;" value="<?=$late_check_out?>" > </label>
                            <select name="late_check_out" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>       
...
<?php
$spa = encrypt('<div class="form-group col-sm-3">
                           <label> Spa </label>
                            <select name="spa" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Spa <input name="location_advantage[spa]" type="checkbox" style="margin-left:10px;" value="<?=$spa?>" > </label>
                            <select name="spa" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$airport_drop = encrypt('<div class="form-group col-sm-3">
                           <label> Airport Pickup & Drop </label>
                            <select name="airport_drop" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Airport Pickup & Drop <input name="location_advantage[airport_drop]" type="checkbox" style="margin-left:10px;" value="<?=$airport_drop?>" > </label>
                            <select name="airport_drop" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$railway_station_pickup_drop = encrypt('<div class="form-group col-sm-3">
                           <label> Railway Station Pickup & Drop </label>
                            <select name="railway_station_pickup_drop" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Railway Station Pickup & Drop <input name="location_advantage[railway_station_pickup_drop]" type="checkbox" style="margin-left:10px;" value="<?=$railway_station_pickup_drop?>" > </label>
                            <select name="railway_station_pickup_drop" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$daily_house_keeping = encrypt('<div class="form-group col-sm-3">
                           <label> Daily HouseKeeping </label>
                            <select name="daily_house_keeping" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Daily HouseKeeping <input name="location_advantage[daily_house_keeping]" type="checkbox" style="margin-left:10px;" value="<?=$daily_house_keeping?>" > </label>
                            <select name="daily_house_keeping" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$welcome_drink = encrypt('<div class="form-group col-sm-3">
                           <label> Welcome Drink </label>
                            <select name="welcome_drink" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Welcome Drink <input name="location_advantage[welcome_drink]" type="checkbox" style="margin-left:10px;" value="<?=$welcome_drink?>" > </label>
                            <select name="welcome_drink" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$ac = encrypt('<div class="form-group col-sm-3">
                           <label> Ac </label>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Ac <input name="location_advantage[ac]" type="checkbox" style="margin-left:10px;" value="<?=$ac?>" > </label>
                            <select name="ac" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$non_ac = encrypt('<div class="form-group col-sm-3">
                           <label> Non Ac </label>
                            <select name="non_ac" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Non Ac <input name="location_advantage[non_ac]" type="checkbox" style="margin-left:10px;" value="<?=$non_ac?>" > </label>
                            <select name="non_ac" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
<?php
$beach_view = encrypt('<div class="form-group col-sm-3">
                           <label> Beach View </label>
                            <select name="beach_view" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Beach View <input name="location_advantage[beach_view]" type="checkbox" style="margin-left:10px;" value="<?=$beach_view?>" > </label>
                            <select name="beach_view" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
  ...
  <!--property location advantage end-->
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
       <div class="card">
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h4 class="card-title">Location Environment </h4>
             </div>
          </div>
          <div class="card-body">
...
<?php
$neighborhood = encrypt('<div class="form-group col-sm-3">
                           <label> Neighborhood </label>
                            <select name="neighborhood" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Neighborhood  <input name="location_environment[neighborhood]" type="checkbox" style="margin-left:10px;" value="<?=$neighborhood?>" > </label>
                            <select name="neighborhood" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>  
...
<?php
$roads = encrypt('<div class="form-group col-sm-3">
                           <label> Roads </label>
                            <select name="roads" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Roads  <input name="location_environment[roads]" type="checkbox" style="margin-left:10px;" value="<?=$roads?>" > </label>
                            <select name="roads" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$safety = encrypt('<div class="form-group col-sm-3">
                           <label> Safety </label>
                            <select name="safety" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Safety <input name="location_environment[safety]" type="checkbox" style="margin-left:10px;" value="<?=$safety?>" > </label>
                            <select name="safety" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$cleanliness = encrypt('<div class="form-group col-sm-3">
                           <label> Cleanliness </label>
                            <select name="cleanliness" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Cleanliness <input name="location_environment[cleanliness]" type="checkbox" style="margin-left:10px;" value="<?=$cleanliness?>" > </label>
                            <select name="cleanliness" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
  ...
  <!--property location environment end-->
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
       <div class="card">
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h4 class="card-title">Location Commuting </h4>
             </div>
          </div>
          <div class="card-body">
...
<?php
$public_transport = encrypt('<div class="form-group col-sm-3">
                           <label> Public Transport </label>
                            <select name="public_transport" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Public Transport  <input name="location_commuting[public_transport]" type="checkbox" style="margin-left:10px;" value="<?=$public_transport?>" > </label>
                            <select name="public_transport" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>  
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Parking  <input name="location_commuting[parking]" type="checkbox" style="margin-left:10px;" value="<?=$parking?>" > </label>
                            <select name="parking" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$connectivity = encrypt('<div class="form-group col-sm-3">
                           <label> Connectivity </label>
                            <select name="connectivity" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Connectivity <input name="location_commuting[connectivity]" type="checkbox" style="margin-left:10px;" value="<?=$connectivity?>" > </label>
                            <select name="connectivity" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$traffic = encrypt('<div class="form-group col-sm-3">
                           <label> Traffic </label>
                            <select name="traffic" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Traffic <input name="location_commuting[traffic]" type="checkbox" style="margin-left:10px;" value="<?=$traffic?>" > </label>
                            <select name="traffic" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
  ...
  <!--property location commuting end-->
...
<div class="row">
    <div class="col-sm-12 col-lg-12">
       <div class="card">
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h4 class="card-title"> Place of Interest </h4>
             </div>
          </div>
          <div class="card-body">
...
<?php
$school = encrypt('<div class="form-group col-sm-3">
                           <label> Schools </label>
                            <select name="school" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Schools  <input name="location_interest[school]" type="checkbox" style="margin-left:10px;" value="<?=$school?>" > </label>
                            <select name="school" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>  
...
<?php
$restaurant = encrypt('<div class="form-group col-sm-3">
                           <label> Restaurant </label>
                            <select name="restaurant" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Restaurant  <input name="location_interest[restaurant]" type="checkbox" style="margin-left:10px;" value="<?=$restaurant?>" > </label>
                            <select name="restaurant" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$hospital = encrypt('<div class="form-group col-sm-3">
                           <label> Hospital </label>
                            <select name="hospital" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Hospital <input name="location_interest[hospital]" type="checkbox" style="margin-left:10px;" value="<?=$hospital?>" > </label>
                            <select name="hospital" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div> 
...
<?php
$market = encrypt('<div class="form-group col-sm-3">
                           <label> Market </label>
                            <select name="market" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                                <option value="yes">Yes</option>
                                <option value="no">No</option>
                            </select>
...
?> 
                        <div class="form-group col-sm-3">
                           <label> Market <input name="location_interest[market]" type="checkbox" style="margin-left:10px;" value="<?=$market?>" > </label>
                            <select name="market" class="form-control form-control-sm mb-3">
                                <option value="">--- select ---</option>
                            </select>
                        </div>
...
$total_floor = encrypt('<div class="form-group col-sm-2">
                           ...
                           <select name="total_floor" class="form-control form-control-sm mb-2">
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                                <option value="4">4</option>
...
<?php
$floor_alow_for_constr = encrypt('<div class="form-group col-sm-4">
                           <label>Floors Allowed for construction</label>
                           <select name="floor_alow_for_constr" class="form-control form-control-sm mb-4">			      
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                                <option value="4">4</option>
...
<?php
$side_open = encrypt('<div class="form-group col-sm-3">
...
<?php
$width_of_road = encrypt('<div class="form-group col-sm-5">
                           <label>Width of road facing the plot (In Meter)</label>
                           <input type="text" name="width_of_road" class="form-control form-control-sm-4"
...
<?php
$furnished_status = encrypt('<div class="form-group col-sm-3">
...
$bed = encrypt('<div class="form-group col-sm-2">
                           <label>Bed</label>
                           <select name="bed" class="form-control form-control-sm mb-2">			          <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                            </select>
...
?>
                        <div class="form-group col-sm-2">
                           ...
                           <select name="bed" class="form-control form-control-sm mb-2">			          <option value="36108">0</option>
                                <option value="36109">1</option>
                                <option value="36110">2</option>
                                <option value="36111">3</option>
                            </select>
...
$wardrobe = encrypt('<div class="form-group col-sm-2">
                           ...
                           <select name="wardrobe" class="form-control form-control-sm mb-2">			      <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                            </select>
...
?>
                        <div class="form-group col-sm-2">
                           ...
                           <select name="wardrobe" class="form-control form-control-sm mb-2">			      <option value="36108">0</option>
                                <option value="36109">1</option>
                                <option value="36110">2</option>
                                <option value="36111">3</option>
                            </select>
...
$tv = encrypt('<div class="form-group col-sm-2">
                           <label>Tv</label>
                           <select name="tv" class="form-control form-control-sm mb-2">			      
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
...
<?php
$fridge = encrypt('<div class="form-group col-sm-2">
                           <label>Fridge</label>
...
<?php
$sofa = encrypt('<div class="form-group col-sm-2">
                           <label>Sofa</label>
...
<?php
$washing_machine = encrypt('<div class="form-group col-sm-3">
...
<?php
$gas_connection = encrypt('<div class="form-group col-sm-3">
...
<?php
$two_bhk = encrypt('<div class="form-group col-sm-1">
                           <label>2 BHK</label>
...
<?php
$daily_rent = encrypt('<div class="form-group col-sm-3">
...
<?php
$other_charge = encrypt('<div class="form-group col-sm-3">
...
$maintenance_charge = encrypt('<div class="form-group col-sm-3" style="position:relative;">
                           ...
                           <input type="text" name="maintenance_charge" class="form-control form-control-sm-4" 
                              placeholder="Maintenance Charges" style="width:60%;">
                            <select name="maintenance_charge_unit" class="form-control form-control-sm-4" style="width: 41%;position: absolute;right: 0;top: 36px;">
...
?>
                        <div class="form-group col-sm-4" style="position:relative;">
                           ...
                           <input type="text" name="maintenance_charge" class="form-control form-control-sm-5" 
                              placeholder="Maintenance Charges" style="width:61%;">
                            <select class="form-control form-control-sm-4" style="width: 41%;position: absolute;right: 0;top: 36px;">
              ...
              <div class="row">
       <?php
$description = encrypt('<div class="form-group col-sm-12">
                           <label> Descriptions </label>
                            <textarea class="form-control" name="description" placeholder="Description here ... "></textarea>
                        </div>');
?>                          
                        <div class="form-group col-sm-12">
                           <label> Description <input name="property_rent_lease[description]" type="checkbox" style="margin-left:10px;" value="<?=$description?>" > </label>
                            <textarea class="form-control" name="description" placeholder="Description here ... "></textarea>
                        </div>
              </div>
...
<script>
    $(document).on('click','.update',function(){
        ...
        $.get("{{route('get_category')}}",{type:type},function(ret){
         ...
         var location_advantage_key = $(this).attr('location_advantage_key').split(','); 
         var location_environment_key = $(this).attr('location_environment_key').split(','); 
         var location_commuting_key = $(this).attr('location_commuting_key').split(','); 
         var location_interest_key = $(this).attr('location_interest_key').split(','); 
        ...
        $.each(location_advantage_key, function( index, value )
        {
          $('input:checkbox[name="location_advantage['+value+']"]').attr('checked', 'checked'); 
        });
        
        $.each(location_environment_key, function( index, value )
        {
          $('input:checkbox[name="location_environment['+value+']"]').attr('checked', 'checked'); 
        });
        
        $.each(location_commuting_key, function( index, value )
        {
          $('input:checkbox[name="location_commuting['+value+']"]').attr('checked', 'checked'); 
        });
        
        $.each(location_interest_key, function( index, value )
        {
          $('input:checkbox[name="location_interest['+value+']"]').attr('checked', 'checked'); 
        });
