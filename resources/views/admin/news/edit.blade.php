...
<form action="{{ url('admin/updateNewsArticle',['article'=>$article->id]) }}" method="post" enctype="multipart/form-data">
 @csrf 
<div class="row"  >
      ...
      <div class="card" >
          <div class="card-header d-flex justify-content-between" style="padding:2px 30px;">
             <div class="header-title">
                <h6 class="card-title">Edit News & Articles Details </h6>
             </div>
          </div>
          <div class="card-body">
               <div class="row">
...
<div class="row">
                      ...
                      <div class="col-sm-4" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="text" class="form-control" value="{{$article->creator}}" name="creator"> 
                         </div>
                      </div>
                      ...
                      <div class="col-sm-4" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="text" class="form-control" value="{{$article->content}}" name="content"> 
                         </div>
                      </div>
              </div>
          </div>
