...
<form action="{{ url('admin/addAdvertise') }}" method="post" enctype="multipart/form-data">
 @csrf 
<div class="row"  >
                     ...
                     <div class="col-sm-3" style="position:relative;">
                      ...
                      <div class="col-sm-3" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="number" class="form-control" name="off"> 
                         </div>
                      </div>
            ...
            <div class="row">
                      ...
                      <div class="col-sm-3" style="position:relative;">
                        ...
                        <div class="input-group input-group-sm ">
                            ...
                            <input type="number" class="form-control" name="actualPrice"> 
                         </div>
                      </div>
