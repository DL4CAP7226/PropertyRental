                              ...
                              <a href="#" class="search-toggle dropdown-toggle  d-flex align-items-center" id="dropdownMenuButton4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                 ...
                                 <div class="caption ml-3">
                                    <h6 class="mb-0 line-height">
                                       <!--Mason Protesters-->{{Auth::user()->name}}
                                       ...
                                       <div class="profile-header">
                                          <div class="cover-container text-center">
                                             ...
                                             <div class="profile-detail mt-3">
                                                <h5><a href="../app/user-profile-edit.html">
                                                      {{Auth::user()->name}}
                                                    </a>
                                                </h5>
                                                <p> {{Auth::user()->email}} </p>
            ...
            <div class="container-fluid">
               <div class="row">
                  ...
                  <div class="col-lg-6 text-right">
                     ...
                     <p class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Copyright © 2008 - 2022,  <a href="https://www.gazingtechnosoft.com/" target="_blank">Gazing Technosoft Pvt. Ltd</a></p>
                  </div>
               </div>
            </div>
         </footer>
