            ...
            <header class="site-header header-opt-1 cate-show">
               ...
               <div class="header-top">
                  <div class="container">
                     <!-- nav-left -->
                     <ul class="nav-left" >
                        <li ><span><strong class="logo">
                           <a href=""><img src="https://gazingdev.website/property/images/propertyrental.png" alt="logo"></a>
                           </strong></span>
                        </li>
                        <li class="dropdown switcher  switcher-currency">
                           <a data-toggle="dropdown" role="button" href="#" class="dropdown-toggle switcher-trigger"><span>New-Delhi</span> <i aria-hidden="true" class="fa fa-angle-down"></i></a>
                     ...
                     <ul class=" nav-right">
                        ...
                        <li class="btn-free"><a href="">Post Property<span>Free</span> </a></li>
                     </ul>
                     <!-- nav-right -->
                  </div>
               </div>
                     ...
                     <div class="box-header-nav">
                        ...
                        <div class="block-nav-menu">
                           ...
                           <ul class="ui-menu">
                                    ...
                                    <ul>
                                       ...
                                       <li class="col-md-3">
                                          <div class="img-categori">
                                             <a href=""><img alt="img" src="{{asset('public/frontend')}}/images/img-categori5.jpg"></a>
                                          </div>
                                       </li>
                                    </ul>
                                 </div>
                              ...
                              <li class="parent parent-megamenu">
                                 ...
                                 <div class="megamenu drop-menu">
                                    <ul>
                                       <li class="col-md-3">
                                          <div class="img-categori">
                                             <a href=""><img alt="img" src="{{asset('public/frontend')}}/images/img-categori1.jpg"></a>
                                          </div>
                                          <strong class="title"><a href=""><span>Women's </span></a></strong>
                                          <ul class="list-submenu">
                                             <li><a href="">Shoes</a></li>
                                       ...
                                       <li class="col-md-3">
                                          <div class="img-categori">
                                             <a href=""><img  alt="img"  src="{{asset('public/frontend')}}/images/img-categori2.jpg"></a>
                                          </div>
                                          <strong class="title"><a href=""><span>Women's </span></a></strong>
                                          <ul class="list-submenu">
                                             <li><a href="">Shoes</a></li>
                                       ...
                                       <li class="col-md-3">
                                          <div class="img-categori">
                                             <a href=""><img alt="img"  src="{{asset('public/frontend')}}/images/img-categori3.jpg"></a>
                                          </div>
                                          <strong class="title"><a href=""> <span>Kid's</span></a></strong>
                                          <ul class="list-submenu">
                                             <li><a href="">Shoes</a></li>
                                       ...
                                       <li class="col-md-3">
                                          <div class="img-categori">
                                             <a href=""><img alt="img"  src="{{asset('public/frontend')}}/images/img-categori4.jpg"></a>
                                          </div>
                              ...
                              <li class="pay_rent"><a href="#"> <span><img src="https://cdn.staticmb.com/magicservicestatic/1640352644442/images/payrent-icon.svg"></span>Pay your Rent</a></li>
                           </ul>
                        </div>
                        <!-- menu -->
                        <!-- mini cart -->
            ...
            <div class="footer-column">
               <div class="row">
                  <div class="col-md-6 col-lg-6 col-xs-6 col">
                     ...
                     <div class="block-content">
                        <img alt="payment" src="{{asset('public/frontend')}}/images/en_badge_web_generic.png">
                        <img alt="payment" src="{{asset('public/frontend')}}/images/en_badge_web_generic.png">
                        ...
                        <a href="" class="sh-youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
                     </div>
                  </div>
                  <div class="col-md-6 col-lg-6 col-xs-6 col">
                     ...
                     <div class="footer-links">
                        <ul class="links">
                           ...
                           <li><a href="">Property  in New Delhi  </a></li>
                           <li><a href="">Property  in New Delhi </a></li>
                           <li><a href="">Property  in New Delhi s  </a></li>
                           <li><a href="">Property  in New Delhi  </a></li>
                           <li><a href="">Property  in New Delhi </a></li>
                           <li><a href="">Property  in New Delhi  </a></li>
                           <li><a href="">Property  in New Delhi    </a></li>
